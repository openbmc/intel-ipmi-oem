 ...
 *
 * @return true if any of "sensors" or "extsensors" sensor paths updated
 * successfully, false if all failed. The "vr" sensor path is optional, and does
 * not participate in the return value.
 */
