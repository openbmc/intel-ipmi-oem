...
class Depex
{
  ...
  private:
    ...
    bool evaluateExprStack(std::stack<int>& values,
                           std::stack<knob::DupexOperators>& operators,
                           int& output)
    {
        ...
        while (!operators.empty())
        {
            ...
            {
                case knob::DupexOperators::OR:
                    values.emplace(a | b);
                    break;

                case knob::DupexOperators::AND:
                    values.emplace(a & b);
                    break;

                case knob::DupexOperators::EQU:
                    if (a == b)
                    {
                        values.emplace(1);
                        break;
                ...
                case knob::DupexOperators::MODULO:
                    if (b == 0)
                    {
                        return false;
                    }
        ...
        for (i = 0; i < expression.length(); i++)
        {
            ...
            else
            {
                ...
                if (word == "_OR_" || word == "OR")
                {
                    ...
                    operators.emplace(knob::DupexOperators::OR);
                }
                else if (word == "_AND_" || word == "AND")
                {
                    ...
                    operators.emplace(knob::DupexOperators::AND);
                }
                else if (word == "_LTE_")
                {
                    operators.emplace(knob::DupexOperators::LTE);
                }
                else if (word == "_LT_")
                {
                    operators.emplace(knob::DupexOperators::LT);
                }
                else if (word == "_NEQ_")
                {
                    operators.emplace(knob::DupexOperators::NEQ);
                }
                else if (word == "_EQU_")
                {
                    operators.emplace(knob::DupexOperators::EQU);
                }
                else if (word == "%")
                {
                    operators.emplace(knob::DupexOperators::MODULO);
                }
                else
                {
