...
static constexpr const char* oemNmiWithSourceObjPathMethod = "NMIWithSource";
    ...
    try
    {
        ...
        if (NMISource != nmi::NMI::NMISource::None)
        {
            auto method = dbus->new_method_call(
                service.c_str(), oemNmiSourceObjPath, oemNmiSourceIntf,
                oemNmiWithSourceObjPathMethod);
