...
ipmi::RspType<uint8_t,                // version
              ...
              uint8_t,                // data1, dependent on parameter
              std::array<uint8_t, 3>> // reserved
    ipmiOemGetEfiBootOptions(uint8_t parameter, uint8_t set, uint8_t block)
{
    using namespace boot_options;
    constexpr const std::array<uint8_t, 3> reserved = {};
...
ipmi::RspType<>
    ipmiOemSetEfiBootOptions(uint8_t bootFlag, uint8_t bootParam,
                             uint8_t bootOption,
                             const std::array<uint8_t, 3>& resereved)
{
    using namespace boot_options;
    bootOption = ((bootOption & bootSourceMask) >> 2); // boot Mode
    auto oneTimeEnabled = false;
