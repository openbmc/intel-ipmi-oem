...
ipmi::RspType<uint8_t> ipmiOEMGetNmiSource(void)
{
    ...
    try
    {
        ...
        switch (sdbusplus::com::intel::Control::server::NMISource::
                convertBMCSourceSignalFromString(std::get<std::string>(variant)))
        {
        case sdbusplus::com::intel::Control::server::NMISource::BMCSourceSignal::None:
            resp.bmcSource = 0;
            break;
        case sdbusplus::com::intel::Control::server::NMISource::BMCSourceSignal::FpBtn:
			resp.bmcSource = 1;
            break;
        case sdbusplus::com::intel::Control::server::NMISource::BMCSourceSignal::WdPreTimeout:
            resp.bmcSource = 2;
            break;
        case sdbusplus::com::intel::Control::server::NMISource::BMCSourceSignal::PefMatch:
            resp.bmcSource = 3;
            break;
        case sdbusplus::com::intel::Control::server::NMISource::BMCSourceSignal::ChassisCmd:
            resp.bmcSource = 4;
            break;
        case sdbusplus::com::intel::Control::server::NMISource::BMCSourceSignal::MemoryError:
            resp.bmcSource = 5;
            break;
        case sdbusplus::com::intel::Control::server::NMISource::BMCSourceSignal::PciSerrPerr:
            resp.bmcSource = 6;
            break;
        case sdbusplus::com::intel::Control::server::NMISource::BMCSourceSignal::SouthbridgeNmi:
            resp.bmcSource = 7;
            break;
        case sdbusplus::com::intel::Control::server::NMISource::BMCSourceSignal::ChipsetNmi:
            resp.bmcSource = 8;
            break;
        default:
             phosphor::logging::log<phosphor::logging::level::ERR>(
    ...
    return ipmi::responseSuccess(resp.bmcSource);
}

ipmi::RspType<> ipmiOEMSetNmiSource(uint8_t sourceId)
{
    sdbusplus::com::intel::Control::server::NMISource::BMCSourceSignal bmcSourceSignal =
        sdbusplus::com::intel::Control::server::NMISource::BMCSourceSignal::None;

	switch (sourceId)
	{
	case 0:
        bmcSourceSignal = sdbusplus::com::intel::Control::server::NMISource::BMCSourceSignal::None;
        break;
	case 1:
        bmcSourceSignal = sdbusplus::com::intel::Control::server::NMISource::BMCSourceSignal::FpBtn;
        break;
	case 2:
        bmcSourceSignal = sdbusplus::com::intel::Control::server::NMISource::BMCSourceSignal::WdPreTimeout;
        break;
	case 3:
        bmcSourceSignal = sdbusplus::com::intel::Control::server::NMISource::BMCSourceSignal::PefMatch;
        break;
	case 4:
        bmcSourceSignal = sdbusplus::com::intel::Control::server::NMISource::BMCSourceSignal::ChassisCmd;
        break;
	case 5:
        bmcSourceSignal = sdbusplus::com::intel::Control::server::NMISource::BMCSourceSignal::MemoryError;
        break;
	case 6:
        bmcSourceSignal = sdbusplus::com::intel::Control::server::NMISource::BMCSourceSignal::PciSerrPerr;
        break;
	case 7:
        bmcSourceSignal = sdbusplus::com::intel::Control::server::NMISource::BMCSourceSignal::SouthbridgeNmi;
        break;
	case 8:
        bmcSourceSignal = sdbusplus::com::intel::Control::server::NMISource::BMCSourceSignal::ChipsetNmi;
        break;
	default:
		 phosphor::logging::log<phosphor::logging::level::ERR>(
			"NMI source: invalid property!");
    ...
    try
    {
        ...
        setDbusProperty(dbus, service, oemNmiSourceObjPath,
                        ...
                        sdbusplus::com::intel::Control::server::convertForMessage(bmcSourceSignal));
    }
    catch (sdbusplus::exception_t& e)
    {
        phosphor::logging::log<phosphor::logging::level::ERR>(e.what());
...
static void registerOEMFunctions(void)
{
    ...
    ipmi::registerHandler(
        ipmi::prioOemBase, netfnIntcOEMGeneral,
        static_cast<ipmi::Cmd>(
            IPMINetfnIntelOEMGeneralCmd::cmdGetNmiStatus),
        ipmi::Privilege::User, ipmiOEMGetNmiSource);

    ipmi::registerHandler(
        ipmi::prioOemBase, netfnIntcOEMGeneral,
        static_cast<ipmi::Cmd>(
            IPMINetfnIntelOEMGeneralCmd::cmdSetNmiStatus),
