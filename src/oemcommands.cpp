    ...
    try
    {
                        ...
                        std::get<std::string>(variant)))
        {
            case sdbusplus::com::intel::Control::server::NMISource::
                ...
                resp.bmcSource = static_cast<uint8_t>(NmiSource::none);
                break;
            case sdbusplus::com::intel::Control::server::NMISource::
                BMCSourceSignal::FpBtn:
                resp.bmcSource = static_cast<uint8_t>(NmiSource::fpBtn);
                break;
            case sdbusplus::com::intel::Control::server::NMISource::
                BMCSourceSignal::WdPreTimeout:
                resp.bmcSource = static_cast<uint8_t>(NmiSource::wdPreTimeout);
                break;
            case sdbusplus::com::intel::Control::server::NMISource::
                BMCSourceSignal::PefMatch:
                resp.bmcSource = static_cast<uint8_t>(NmiSource::pefMatch);
                break;
            case sdbusplus::com::intel::Control::server::NMISource::
                BMCSourceSignal::ChassisCmd:
                resp.bmcSource = static_cast<uint8_t>(NmiSource::chassisCmd);
                break;
            case sdbusplus::com::intel::Control::server::NMISource::
                BMCSourceSignal::MemoryError:
                resp.bmcSource = static_cast<uint8_t>(NmiSource::memoryError);
                break;
            case sdbusplus::com::intel::Control::server::NMISource::
                BMCSourceSignal::PciSerrPerr:
                resp.bmcSource = static_cast<uint8_t>(NmiSource::pciSerrPerr);
                break;
            case sdbusplus::com::intel::Control::server::NMISource::
            ...
            case sdbusplus::com::intel::Control::server::NMISource::
                ...
                resp.bmcSource = static_cast<uint8_t>(NmiSource::chipsetNmi);
                break;
            default:
                phosphor::logging::log<phosphor::logging::level::ERR>(
