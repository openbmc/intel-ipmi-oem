...
static void RegisterNetfnFirmwareFunctions(void)
{
    ...
    ipmi_register(netfnIntcOEMGeneral, IPMI_CMD_WILDCARD, NULL, IPMIOEMWildcard,
                  PRIVILEGE_USER); // wildcard default handler
    ipmi_register(netfnIntcOEMGeneral, CmdGetChassisIdentifier, NULL,
                  IPMIOEMGetChassisIdentifier,
                  PRIVILEGE_USER); // get chassis identifier
    ipmi_register(netfnIntcOEMGeneral, CmdSetSystemGUID, NULL,
                  IPMIOEMSetSystemGUID,
                  PRIVILEGE_ADMIN); // set system guid
    ipmi_register(netfnIntcOEMGeneral, CmdSetBIOSID, NULL, IPMIOEMSetBIOSID,
                  PRIVILEGE_ADMIN);
    ipmi_register(netfnIntcOEMGeneral, CmdGetOEMDeviceInfo, NULL,
                  IPMIOEMGetDeviceInfo, PRIVILEGE_USER);
    ipmi_register(netfnIntcOEMGeneral, CmdGetAICSlotFRUIDSlotPosRecords, NULL,
                  IPMIOEMGetAICFRU, PRIVILEGE_USER);
    ipmi_register(netfnIntcOEMGeneral, CmdSetPowerRestoreDelay, NULL,
                  IPMIOEMSetPowerRestoreDelay, PRIVILEGE_OPERATOR);
    ipmi_register(netfnIntcOEMGeneral, CmdGetPowerRestoreDelay, NULL,
                  IPMIOEMGetPowerRestoreDelay, PRIVILEGE_USER);
    ipmi_register(netfnIntcOEMGeneral, CmdGetProcessorErrConfig, NULL,
                  IPMIOEMGetProcessorErrConfig, PRIVILEGE_USER);
    ipmi_register(netfnIntcOEMGeneral, CmdSetProcessorErrConfig, NULL,
