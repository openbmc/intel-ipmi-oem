                                          ...
                                          const bool flag)
{
    ...
    if (flag)
    {
        atScaleDebugEventlog("SecurityASDFeatureEnabled", LOG_CRIT);
    }
    else
    {
        atScaleDebugEventlog("SecurityASDFeatureDisabled", LOG_INFO);
    }
                                              ...
                                              std::vector<uint8_t> userPassword)
{
    ...
    if (userPassword.size() != 0)
    {
            ...
            static_cast<uint8_t>(SpecialUserIndex::atScaleDebugUser))
        {
            ...
            atScaleDebugEventlog("SecurityASDSpecialUserEnabled", LOG_CRIT);
    ...
    else
    {
        ...
        else
        {
            ...
            if (status == 0)
            {
                ...
                atScaleDebugEventlog("SecurityASDSpecialUserDisabled",
                                     LOG_INFO);
