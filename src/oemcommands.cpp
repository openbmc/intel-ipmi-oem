...
static constexpr const char* oemSmiTimeoutIntf =  "xyz.openbmc_project.SmiTimeout.SMITimeout";
static constexpr const char* oemSmiTimeoutObjPath = "/xyz/openbmc_project/SmiTimeout/SMITimeout";
...
ipmi::RspType<> ipmiOEMControlHostReset(uint8_t disableMask)
{
    try
    {
        ...
        ipmi::setDbusProperty(*pdbus, service, oemSmiTimeoutObjPath, oemSmiTimeoutIntf,
                        oemSmiEnabledObjPathProp, enSmi);
    }
...
ipmi::RspType<uint8_t> ipmiOEMGetHostResetStatus(void)
{
    ...
    try
    {
        ...
        std::string service =
            getService(*pdbus, oemSmiTimeoutIntf, oemSmiTimeoutObjPath);
        Value dbusValue = ipmi::getDbusProperty(*pdbus, service, oemSmiTimeoutObjPath, oemSmiTimeoutIntf,
                        oemSmiEnabledObjPathProp);
