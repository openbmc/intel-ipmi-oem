...
static bool cpuPresent(const std::string& cpuName)
{
    ...
    {
        phosphor::logging::log<phosphor::logging::level::ERR>(
            "Failed to fetch processor presence",
    ...
    ipmiOEMGetProcessorErrConfig()
{
    ...
    return ipmi::responseSuccess(
        resetOnCATERR, resetOnERR2, 0, 0x3F, cpu1CATERRCount,
        static_cast<uint2_t>(cpu1Status), cpu2CATERRCount,
        static_cast<uint2_t>(cpu2Status), cpu3CATERRCount,
        static_cast<uint2_t>(cpu3Status), cpu4CATERRCount,
        static_cast<uint2_t>(cpu4Status), crashdumpCount);
}
