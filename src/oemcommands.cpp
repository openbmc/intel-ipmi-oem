                                    ...
                                    uint8_t restrictionMode)
{
    ...
    if (restrictionMode <
            static_cast<uint8_t>(
                securityNameSpace::RestrictionMode::Modes::Provisioning) ||
        restrictionMode >
            static_cast<uint8_t>(securityNameSpace::RestrictionMode::Modes::
    ...
    uint8_t currentRestrictionMode = static_cast<uint8_t>(
        securityNameSpace::RestrictionMode::convertModesFromString(
            std::get<std::string>(varRestrMode)));
        ...
        *ctx->yield, ec, restricionModeService, restricionModeBasePath,
        ...
        static_cast<std::variant<std::string>>(
            securityNameSpace::convertForMessage(
                static_cast<securityNameSpace::RestrictionMode::Modes>(
                    restrictionMode))));
