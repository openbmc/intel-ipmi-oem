...
static int executeCmd(const char* path)
{
...
static int8_t controlAtScaleDebugService(const bool flag)
{
                                              ...
                                              std::vector<uint8_t> userPassword)
{
    ...
    if (userPassword.size() != 0)
    {
        ...
        if (specialUserIndex == 1)
        {
            ...
            controlAtScaleDebugService(true);
        }
        else
        {
    ...
    else
    {
        ...
        else
        {
            ...
            if (status == 0)
            {
                ...
                controlAtScaleDebugService(false);
            }
        }
        return ipmi::response(status);
    }
