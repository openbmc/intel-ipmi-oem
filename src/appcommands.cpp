...
bool getCurrentBmcState(ipmi::Context::ptr ctx)
{
    ...
    if (ec)
    {
        phosphor::logging::log<phosphor::logging::level::ERR>(
            "getCurrentBmcState: Failed to perform GetSubTree action",
    ...
    {
        phosphor::logging::log<phosphor::logging::level::ERR>(
            "getCurrentBmcState: Invalid size of objects returned");
        return false;
    }
    ...
    {
        phosphor::logging::log<phosphor::logging::level::ERR>(
            "getCurrentBmcState: Failed to get CurrentBMCState property",
            phosphor::logging::entry("ERROR=%s", ec.message().c_str()));
        return false;
    }
    ...
    {
        phosphor::logging::log<phosphor::logging::level::ERR>(
            "getCurrentBmcState: Get CurrentBMCState property type mismatch");
        return false;
    }
    ...
    ipmiAppGetDeviceId(ipmi::Context::ptr ctx)
{
    ...
    bool bmcDevBusy = getCurrentBmcState(ctx);
