        ...
        (criticalInterface != sensorMap.end()))
    {
        ...
        if (warningInterface != sensorMap.end())
        {
            ...
            if (warningHigh != warningMap.end())
            {
                ...
                double value =
                    apply_visitor(VariantToDoubleVisitor(), warningHigh->second);
        ...
        if (criticalInterface != sensorMap.end())
        {
            ...
            if (criticalHigh != criticalMap.end())
            {
                ...
                double value =
                    apply_visitor(VariantToDoubleVisitor(), criticalHigh->second);
            ...
            if (criticalLow != criticalMap.end())
            {
                ...
                double value =
                    apply_visitor(VariantToDoubleVisitor(), criticalLow->second);
