 ...
 */
ipmi::RspType<> ipmiSenSetSensorThresholds(uint8_t sensorNum, uint8_t mask,
                                           ...
                                           uint8_t upperNonRecoverable)
{
    ...
    phosphor::logging::log<phosphor::logging::level::ERR>(
        "Jaya ipmiSenSetSensorThresholds");
    phosphor::logging::log<phosphor::logging::level::ERR>(
        "thresholdChanged: Assert non bool");
    ...
    bool setLowerCritical =
        mask & static_cast<uint8_t>(SensorThresholdReqEnable::setLowerCritical);
    bool setUpperCritical =
        mask & static_cast<uint8_t>(SensorThresholdReqEnable::setUpperCritical);
...
{
    phosphor::logging::log<phosphor::logging::level::ERR>(
        "Jaya ipmiSenGetSensorThresholds");
    std::string connection;
    std::string path;
