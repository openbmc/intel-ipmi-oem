        ...
        (criticalInterface != sensorMap.end()))
    {
        ...
        if (warningInterface != sensorMap.end())
        {
            ...
            if (warningHigh != warningMap.end())
            {
                ...
                double value =
                    apply_visitor(DoubleVisitor(), warningHigh->second);
            ...
            if (warningLow != warningMap.end())
            {
                ...
                double value =
                    apply_visitor(DoubleVisitor(), warningLow->second);
        ...
        if (criticalInterface != sensorMap.end())
        {
            ...
            if (criticalHigh != criticalMap.end())
            {
                ...
                double value =
                    apply_visitor(DoubleVisitor(), criticalHigh->second);
            ...
            if (criticalLow != criticalMap.end())
            {
                ...
                double value =
                    apply_visitor(DoubleVisitor(), criticalLow->second);
