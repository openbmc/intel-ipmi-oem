...
bool constructSensorSdr(boost::asio::yield_context yield, uint16_t sensorNum,
                        ...
                        get_sdr::SensorDataFullRecord& record)
{
    ...
    SensorMap sensorMap;
    if (!getSensorMap(yield, service, path, sensorMap,
...
bool constructVrSdr(boost::asio::yield_context yield, uint16_t sensorNum,
                    uint16_t recordID, const std::string& service,
                    const std::string& path,
                    get_sdr::SensorDataEventRecord& record)
{
                        ...
                        uint8_t readBytes)
{
                  ...
                  sensor::sensorInterface) != interfaces.end())
    {
        ...
        else if (!constructSensorSdr(ctx->yield, sensorNum, recordID,
        ...
        interfaces.end())
    {
        ...
        else if (!constructVrSdr(ctx->yield, sensorNum, recordID, connection,
                                 path, record))
        {
            return GENERAL_ERROR;
        }
