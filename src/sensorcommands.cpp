    ...
    ipmiSenGetSensorEventStatus(uint8_t sensorNum)
{
    ...
    {
        deassertions.set(static_cast<uint8_t>(
        ...
        (criticalInterface != sensorMap.end()))
    {
        ...
        if (warningInterface != sensorMap.end())
        {
            ...
            {
                assertions.set(
                    static_cast<uint8_t>(IPMIGetSensorEventEnableThresholds::
                                             upperNonCriticalGoingHigh));
            }
            if (warningLowAlarm)
            {
                assertions |= 1; // lower nc going low
            }
        }
        if (criticalInterface != sensorMap.end())
        {
            ...
            if (criticalLowAlarm)
            {
                assertions.set(static_cast<uint8_t>(
