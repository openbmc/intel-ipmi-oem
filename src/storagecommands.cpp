...
ipmi::RspType<uint8_t, uint16_t, uint16_t, uint32_t, uint32_t, uint8_t>
    ipmiStorageGetSELInfo()
{
    ...
    uint8_t operationSupport = intel_oem::ipmi::sel::selOperationSupport;

    return ipmi::responseSuccess(selVersion, entries, 0xFFFF, addTimeStamp,
                                 eraseTimeStamp, operationSupport);
}

using systemEventType =
    std::tuple<uint32_t, uint16_t, uint8_t, uint8_t, uint8_t, uint7_t, uint1_t,
               std::array<uint8_t, intel_oem::ipmi::sel::systemEventSize>>;
using oemTsEventType =
    std::tuple<uint32_t,
               std::array<uint8_t, intel_oem::ipmi::sel::oemTsEventSize>>;
using oemEventType = std::array<uint8_t, intel_oem::ipmi::sel::oemEventSize>;

ipmi::RspType<uint16_t, uint16_t, uint8_t,
              std::variant<systemEventType, oemTsEventType, oemEventType>>
                           ...
                           uint8_t offset, uint8_t size)
{
    ...
    if (recordType == intel_oem::ipmi::sel::systemEvent)
    {
        ...
        uint1_t eventDir = std::stoul(targetEntryFields[6]) ? 0 : 1;
...
void registerStorageFunctions()
{
    ...
    ipmi::registerHandler(ipmi::prioOpenBmcBase, ipmi::netFnStorage,
                          static_cast<ipmi::Cmd>(ipmi::storage::cmdGetSelInfo),
                          ipmi::Privilege::Operator, ipmiStorageGetSELInfo);

    // <Get SEL Entry>
    ipmi::registerHandler(ipmi::prioOpenBmcBase, ipmi::netFnStorage,
                          static_cast<ipmi::Cmd>(ipmi::storage::cmdGetSelEntry),
    ...
    // <Clear SEL>
    ipmi::registerHandler(ipmi::prioOpenBmcBase, ipmi::netFnStorage,
                          static_cast<ipmi::Cmd>(ipmi::storage::cmdClearSel),
                          ipmi::Privilege::Operator, ipmiStorageClearSEL);

    // <Set SEL Time>
    ipmi::registerHandler(ipmi::prioOpenBmcBase, ipmi::netFnStorage,
                          static_cast<ipmi::Cmd>(ipmi::storage::cmdSetSelTime),
