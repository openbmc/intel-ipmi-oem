...
void registerAppFunctions()
{
    ...
    printRegistration(
        NETFUN_APP,
        static_cast<unsigned int>(IPMINetfnGlobalCmds::ipmiCmdGlobalSelfTest));
    ipmi_register_callback(
        NETFUN_APP,
        static_cast<ipmi_cmd_t>(IPMINetfnGlobalCmds::ipmiCmdGlobalSelfTest),
        NULL, ipmiGlobalGetSelfTestResults, PRIVILEGE_OPERATOR);
