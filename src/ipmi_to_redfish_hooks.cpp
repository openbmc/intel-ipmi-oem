...
static bool biosMessageHook(SELData& selData, std::string& ipmiRaw)
{
...
static bool biosSMIMessageHook(SELData& selData, std::string& ipmiRaw)
{
...
static bool defaultMessageHook(std::string& ipmiRaw)
{
...
static bool startRedfishHook(SELData& selData, std::string& ipmiRaw)
{
