                                                       ...
                                                       size_t bkcVerOffsetInPfm)
{
    ...
    try
    {
        ...
        fwSecurityVersionBuf.at(svnIndexValue) = temp.at(svnIndexValue);
        spiDev.spiReadData(bkcVerOffsetInPfm, bufLength, temp.data());
        fwSecurityVersionBuf.at(bkcIndexValue) = temp.at(svnIndexValue);
    }
    catch (const std::exception& e)
    {
        phosphor::logging::log<phosphor::logging::level::ERR>(
    ...
    ipmiGetFwSecurityVersionInfo()
{
    ...
    std::array<std::array<uint8_t, imageCount>, imageCount>
        imgFwSecurityVersion = {(0, 0), (0, 0)};
    constexpr size_t svnActiveVerOffsetInPfm = 0x404;
    constexpr size_t bkcActiveVerOffsetInPfm = 0x405;
    constexpr size_t svnRecoveryVerOffsetInPfm = 0x804;
    constexpr size_t bkcRecoveryVerOffsetInPfm = 0x805;
