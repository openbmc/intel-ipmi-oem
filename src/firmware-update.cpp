    ...
    ipmiGetFwUpdateRandomNumber(const ipmi::Context::ptr ctx)
{
    ...
    {
        phosphor::logging::log<phosphor::logging::level::ERR>(
            "Command not supported. Failed to fetch FW update random number");
                              ...
                              std::array<uint8_t, fwRandomNumLength> &randNum)
{
    ...
    {
        phosphor::logging::log<phosphor::logging::level::ERR>(
            "Command not supported. Failed to set FW update mode");
        return ipmi::responseCommandNotAvailable();
    }
                                    ...
                                    const std::optional<std::string> &fileName)
{
    ...
    {
        phosphor::logging::log<phosphor::logging::level::ERR>(
            "Command not supported. Failed to get or set FW update control");
        return ipmi::responseCommandNotAvailable();
    }
    ...
    std::optional<std::vector<uint8_t>> integrityCheckVal)
{
    ...
    {
        phosphor::logging::log<phosphor::logging::level::ERR>(
            "Command not supported. Failed to set firmware update options");
        return ipmi::responseCommandNotAvailable();
    }
