...
#define EXPECTED_SLOP_X (2)

// Unlike EXPECTED_SLOP_X, this is a ratio, not an integer
// It scales based on the range of "y"
#define EXPECTED_SLOP_Y (0.01)
               ...
               bool bSigned, double yRange)
{
    ...
    if (bSigned)
    {
        ...
        EXPECT_NEAR(actual, expect, EXPECTED_SLOP_X);
    }
    else
    {
        uint8_t expect = x;
    ...
    double yTolerance = yRange * EXPECTED_SLOP_Y;
