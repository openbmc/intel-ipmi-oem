...
struct bus
{
    ...
    {
        sd_bus_message* m = nullptr;
        sd_bus_message_new_method_call(_bus.get(), &m, service, objpath, interf,
                                       method);
                               ...
                               const std::vector<std::string>& ifaces)
    {
        ...
        sd_bus_emit_interfaces_added_strv(_bus.get(), path,
                                          static_cast<char**>(s));
    }
    ...
    {
        details::Strv s{ifaces};
        sd_bus_emit_interfaces_removed_strv(_bus.get(), path,
                                            static_cast<char**>(s));
    }
